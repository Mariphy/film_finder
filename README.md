...
## Description
*This is a Codecademy project on introductory back-end. Aimed at training async GET requests and using APIs. The files for the project were prepared by the Codecademy team. I worked in the script.js file to complete this project.*
...
## How to use
You"ll need to add your own api key for the program to run.